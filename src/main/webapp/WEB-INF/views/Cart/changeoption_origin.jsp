...
function optionclose() {//팝업창이 꺼지면서 부모창이 변경
// 	var cartNum = $("input[name=p_no]").val();
// 	alert(cartNum);
// 	window.open('Cartlist?p_no='+cartNum, '옵션변경', 'width=700px,height=800px,scrollbars=yes');
...
<h3>옵션 변경</h3>
<hr />
<form onsubmit="return optionclose()" name="forms">
...
<!-- 		<input type="button" name="size" value="105(XL)" onclick="selectsize('xl');"/> -->	
	...
	<input type="submit" value="선택완료" onclick="daupdate();" />	
